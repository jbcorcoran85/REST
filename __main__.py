...
if __name__ == "__main__":
    ...
    parser.add_argument('-key-file', '--key-file', default="", action='store', dest='keyfile_path')      # option that takes a value

    env = parser.parse_args()
    auth.simple_salesforce_auth(env.connected_app_id, env.salesforce_url, env.sfdc_username,env.keyfile_path)
    auth.requests_auth()
